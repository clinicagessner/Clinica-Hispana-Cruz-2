...
const copy = {
  es: {
    ...
    metaDescription:
      "Atención médica profesional 100% en español. Sin cita previa, walk-ins. Más de 500 reseñas 5★ en Google. Llame: (281) 789-0484",
    ...
    diffSectionTitle: "¿Por qué los hispanos eligen Clínica Hispana Cruz 2?",
    diffSectionDesc:
    ...
    mapTitle: "Ubicación Clínica Hispana Cruz 2",
    ...
    faqItems: [
      ...
      },
      {
        ...
        a: "Estamos en 13331 Kuykendahl Rd Ste 128, Houston TX 77090, en el norte de Houston cerca de la autopista 59/69. Estacionamiento gratuito y fácil acceso en transporte público.",
      },
    ],
  ...
  en: {
    ...
    metaDescription:
      "Professional medical care 100% in Spanish. Walk-ins welcome, no appointment needed. 500+ 5-star Google reviews. Call: (281) 789-0484",
    ...
    diffSectionTitle: "Why hispanic patients choose Clínica Hispana Cruz 2",
    diffSectionDesc:
    ...
    mapTitle: "Clínica Hispana Cruz 2 location",
    ...
    faqItems: [
      ...
      },
      {
        ...
        a: "We're at 13331 Kuykendahl Rd Ste 128, Houston TX 77090, in north Houston near Highway 59/69. Free parking and easy public transportation access.",
      },
    ],
    ...
    <main>
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        <Image
          ...
          alt="Clínica Hispana Cruz 2 - Houston TX"
          width={1920}
          height={1080}
          priority
          fetchPriority="high"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 max-w-5xl mx-auto">
            {featuredServices.map((service) => (
              ...
              >
                <Image
                  src={service.image}
                  alt={`${service.title} - Clínica Hispana Cruz 2 Houston`}
                  fill
