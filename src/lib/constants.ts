...
export const PROMOTIONS: Promotion[] = [
  {
    ...
    alt: "Promoción de chequeo completo de mujer por $79 con Papanicolaou y consulta ginecológica en Clínica Hispana Cruz 2 Houston",
    altEn: "Complete women's checkup promotion for $79 with Pap smear and gynecological consultation at Clínica Hispana Cruz 2 Houston",
    highlighted: true,
    order: 1,
  },
  {
    ...
    price: "$89",
    blurb:
      "Chequeo completo para hombres que evalúa la salud urinaria, la próstata (prevención de cáncer) y los niveles de testosterona, en una sola visita sin cita previa.",
    blurbEn:
      "A complete men's checkup covering urinary health, the prostate (cancer prevention) and testosterone levels, in a single walk-in visit.",
    includes: [
      "Examen de orina",
    ...
    alt: "Promoción de chequeo completo para hombres por $89 con examen de orina, próstata y testosterona en Clínica Hispana Cruz 2 Houston",
    altEn: "Complete men's checkup promotion for $89 with urine, prostate and testosterone testing at Clínica Hispana Cruz 2 Houston",
    highlighted: true,
    order: 2,
  },
  {
    slug: "examen-general-sangre",
    title: "Examen General de Sangre",
    titleEn: "General Blood Panel",
    price: "$99",
    blurb:
      "Examen general de sangre para conocer el estado de tu salud y detectar a tiempo condiciones como anemia, diabetes o colesterol alto. Resultados confiables de laboratorio.",
    blurbEn:
      "A general blood panel to assess your overall health and detect conditions like anemia, diabetes or high cholesterol early. Reliable lab results.",
    includes: [
      "Panel general de sangre",
      "Toma de muestra en la clínica",
      "Resultados de laboratorio confiables",
    ],
    includesEn: [
      "General blood panel",
    ...
    image: "/images/promotions/examen-general-sangre.webp",
    alt: "Promoción de examen general de sangre por $99 en Clínica Hispana Cruz 2 Houston",
    altEn: "General blood panel promotion for $99 at Clínica Hispana Cruz 2 Houston",
    highlighted: true,
    order: 3,
  },
  {
    slug: "vitaminas-inyectables",
    title: "6 Vitaminas Inyectables",
    titleEn: "6 Injectable Vitamins",
    price: "$150",
    blurb:
      "Paquete de 6 vitaminas inyectables para apoyar tu energía y bienestar general. Recarga tu cuerpo con la guía de nuestro equipo médico.",
    blurbEn:
      "A package of 6 injectable vitamins to support your energy and overall wellness. Recharge your body with the guidance of our medical team.",
    includes: [
      "6 vitaminas inyectables",
      "Aplicación por personal médico",
      "Oferta especial por tiempo limitado",
    ],
    includesEn: [
      "6 injectable vitamins",
      "Administered by medical staff",
      "Limited-time special offer",
    ],
    image: "/images/promotions/vitaminas-inyectables.webp",
    alt: "Promoción de 6 vitaminas inyectables por $150 en Clínica Hispana Cruz 2 Houston",
    altEn: "6 injectable vitamins promotion for $150 at Clínica Hispana Cruz 2 Houston",
    order: 4,
  },
  {
