...
export const PROMOTIONS: Promotion[] = [
  {
    ...
    price: "$99",
    blurb:
      "Chequeo preventivo completo con examen general de sangre y electrocardiograma (EKG), más examen general de orina y consulta médica gratis. Oferta por tiempo limitado.",
    blurbEn:
      "A complete preventive checkup with a general blood panel and electrocardiogram (EKG), plus a free urine test and free medical consultation. Limited-time offer.",
    includes: [
    ...
    alt: "Promoción de chequeo completo de salud por $99 con examen de sangre y electrocardiograma en Clínica Hispana Cruz 2 Houston",
    altEn: "Complete health checkup promotion for $99 with blood work and EKG at Clínica Hispana Cruz 2 Houston",
    highlighted: true,
    order: 1,
  },
  {
